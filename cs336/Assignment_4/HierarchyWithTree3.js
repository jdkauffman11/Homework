//
// Hierarchical object using recursion.  Depends on CS336Object.js.
//
...
shaft.setScale(2, 10, 2);
turbineDummy.addChild(shaft);

var housingDummy = new CS336Object();
housingDummy.setPosition(0, 7, 0);
turbineDummy.addChild(housingDummy);

var housing = new CS336Object(drawCube);
housing.setPosition(0, 0, 0);
housing.setScale(4, 3, 6);
housingDummy.addChild(housing);

var hubDummy = new CS336Object();
hubDummy.setPosition(0, 0, 4);
housingDummy.addChild(hubDummy);

var hub = new CS336Object(drawCube);
hub.setPosition(0, 0, 0);
hub.setScale(2, 2, 2);
hubDummy.addChild(hub);

var bladeDummy = new CS336Object();
bladeDummy.setPosition(0, -4.5, 0.0);
hubDummy.addChild(bladeDummy);

var blade = new CS336Object(drawCube);
blade.setPosition(0, 1, 0);
blade.setScale(2, 6, 1);
bladeDummy.addChild(blade);

var blade2 = new CS336Object(drawCube);
blade2.setPosition(0, 8, 0);
blade2.setScale(2, 6, 1);
bladeDummy.addChild(blade2);

//var hand = new CS336Object(drawCube);
//hand.setPosition(0, -6.5, -1.0);
//hand.setScale(1, 3, 3);
//bladeDummy.addChild(hand);
...
function handleKeyPress(event)
{
	...
	{
    //case 't':
		//turbineDummy.setRotation(new Matrix4().setRotate(15, 0, 1, 0).multiply(turbineDummy.rotation));
		//break;
    //case 'T':
    //turbineDummy.setRotation(new Matrix4().setRotate(-15, 0, 1, 0).multiply(turbineDummy.rotation));
		//break;
	case 's':
        direction = -1.0;
	   //hubDummy.setRotation(new Matrix4().setRotate(-15, 0, 0, 1).multiply(hubDummy.rotation));
		break;
	case 'S':
        direction = 1.0;
    //hubDummy.setRotation(new Matrix4().setRotate(15, 0, 0, 1).multiply(hubDummy.rotation));
		break;
	case 'a':
    bladeDummy.setRotation(new Matrix4().setRotate(-15, 0, 1, 0).multiply(bladeDummy.rotation));
		break;
	case 'A':
    bladeDummy.setRotation(new Matrix4().setRotate(15, 0, 1, 0).multiply(bladeDummy.rotation));
		break;
	...
	//	break;
	case 'l':
	   housingDummy.setRotation(new Matrix4().setRotate(15, 0, 1, 0).multiply(housingDummy.rotation));
		break;
	case 'L':
    housingDummy.setRotation(new Matrix4().setRotate(-15, 0, 1, 0).multiply(housingDummy.rotation));
		break;
...
function draw()
{
  // clear the framebuffer
    ...
    hubDummy.setRotation(new Matrix4().setRotate(direction*10, 0, 0, 1).multiply(hubDummy.rotation));

	// recursively render everything in the hierarchy
	turbineDummy.render(new Matrix4());
}
